...
public class StringTool {
	...
	public static String getMapString(Map paramMap, String mapStr,String defaultValue) {
		String returnString = (paramMap!=null && paramMap.get(mapStr) != null) ? paramMap.get(mapStr).toString() : defaultValue;
		return returnString;
	}
